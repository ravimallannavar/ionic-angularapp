...
export class AssetdetailComponent implements OnInit {
  ...
  InsertAssetDetails(asset_id, assetMasterId) {
    ...
    this.asset.PhysicalAssetsId_ = this.phy_asset;
    this.asset.BALMisIdChar_ = this.balmis_checkid;
    ...
    this.assetService.InsertAssetDetails(this.asset).subscribe(Response => {
      ...
      console.log(Messages.InsertAssetDetails);
    }, error => {
